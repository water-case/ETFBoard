...
<div class="container">
  ...
  <div class="row mb-2">
      <div class="col-md-6 text-right align-self-center">
        <strong>추가할 ETF의 종목코드를 입력하세요 : </strong>
      </div>
      <div class="col-md-2">
        <input class="form-control" type="text" style="text-align:center;" maxlength='6'>
      </div>
      <div class="col-md-2 pl-0">
        <button type="button" class="btn btn-primary">종목추가</button>
      </div>
  ...
  <table class="table table-sm">
	<thead>
	  <tr class="table-sm table-active">
	    ...
	    <th class="text-center" scope="col" style="width:20%">종목명</th>
	...
	<tbody>
	  <c:forEach var="checkList" items="${checkList}">
		<tr>
	      ...
	      <td class="text-left align-middle"><a id="ltemlink" href="https://finance.naver.com/item/main.naver?code=${checkList.itemcode}" target="_blank">${itemName}</a></td>
	      <td class="text-right align-middle">${nowPrice}</td>
